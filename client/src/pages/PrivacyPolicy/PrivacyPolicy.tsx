        ...
        <div>
            ...
            <div className={styles["content-div"]}>
                <div className={styles["main-content"]}>
                    ...
                    <h2>(Last Update:  July 20, 2024)</h2>
                    <p className= {styles["text"]}>
Next Play Games (the “Company”) is committed to maintaining robust privacy protections 
for its users. Our Privacy Policy (“Privacy Policy”) is designed to help you understand how 
we collect, use and safeguard the information you provide to us and to assist you in making 
informed decisions when using our Service.<br /><br />
 
For purposes of this Agreement, “Site” refers to the Company’s website, which can be 
accessed at nextplayfantasy.com
“Service” refers to the Company’s services accessed via the Site, in which users can play
fantasy sports contests. 
The terms “we,” “us,” and “our” refer to the Company.
“You” refers to you, as a user of our Site or our Service. 
By accessing our Site or our Service, you accept our Privacy Policy and Terms of Use 
(found here: nextplayfantasy.com/terms), and you consent to our collection, storage, use 
and disclosure of your Personal Information as described in this Privacy Policy.<br /><br />
 
...
submit and number of clicks. Personal Information includes your email, address, date of birth,
contact information, etc., which you submit to us through the registration process at the Site.<br /><br />
 
...
email address, address, date of birth, and contact information. To use the Service thereafter, 
you do not need to submit further Personal Information. However, in an effort to improve the 
...
basis. For example, the Company may use cookies to collect the following information:<br />
<ul className={styles["list"]}>
    <li>actions on a site;</li>
    <li>browsing behavior;</li>
    <li>preferences;</li>
    <li>which links you click on.</li>
  </ul>
...
store and use your email address in accordance with this Privacy Policy.<br /><br />
 
...
have collected such information, please contact us.<br /><br />
 
...
or the public as required or permitted by law.<br /><br />
 
...
periodically if you are concerned about how your information is used.<br /><br />
 
...
understand and agree to assume these risks.<br /><br />
 
...
each promotional e-mail. You can also indicate that you do not wish to receive marketing 
communications from us in the Account Settings section of the Site. Please note
notwithstanding the promotional preferences you indicate by either unsubscribing or opting 
out on the Site, we may continue to send you administrative emails including, for example, 
periodic updates to our Privacy Policy.<br /><br />
 
...
statements of other websites before proceeding to use them.<br /><br />
 
VI.           CHANGES TO OUR PRIVACY POLICY<br />
The Company reserves the right to change this policy and our Terms of Service at any 
time. We will notify you of significant changes to our Privacy Policy by sending a notice to 
the primary email address specified in your account or by placing a prominent notice on our 
...
contact us by sending an email.<br />
Last Updated: This Privacy Policy was last updated on July 20, 2024.<br /><br />
</p>
                </div>
            </div>
